...
cp /opt/games/usr/waydroid/waydroid_base.prop /opt/games/run/waydroid/waydroid.prop
...
mount /opt/games/usr/waydroid/images/system.img /opt/games/run/waydroid/rootfs
mount /opt/games/usr/waydroid/images/vendor.img /opt/games/run/waydroid/rootfs/vendor
...
lxc-start -P /opt/games/usr/waydroid/lxc -n waydroid -F
